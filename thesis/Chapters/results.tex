...
\section{Analysis}
The evaluation of the results shows, that a containerized deployment on \ac{Windows} is still in a early state. Even though, Docker and its \ac{CRI} was used for a long time, containerization using \ac{Windows} host process isolation is not convenient and error resilient.
